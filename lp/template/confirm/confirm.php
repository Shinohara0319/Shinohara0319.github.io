  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST["submit"])) {
      ...
      if ($sendAdmin && $sendUser) {
        ...
        // サンクスページに画面遷移させる
        header("Location: http://" . $_SERVER["HTTP_HOST"] . "/complete/complete.php");
        exit;
      } else {
        ...
        <div class="common_contact contact_confirm">
          <div class="inner_min">
            ...
            <div class="contact_box">
              ...
              <div class="list flex is-between">
                <label for="your_staffNumber">部署名</label>
                <div class="input_list">
                  <div class="flex is-between">
                    <?php echo $staffNumber; ?>
                  </div>
                </div>
              </div>

              <div class="list flex is-between">
                <label for="your_name">担当名</label>
                <div class="input_list">
                  <div class="flex is-between">
                    <?php echo $sei; ?>
                    <?php echo $mei; ?>
              ...
              <div class="submit_box">
                ...
                <form method="post" action="/confirm/confirm.php">
