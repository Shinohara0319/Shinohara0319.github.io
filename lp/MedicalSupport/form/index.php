          ...
          <div class="inner_min">
            ...
            <form method="post" name="form" id="form" action="confirm.php">
              <div class="contact_box">
                ...
                <div class="list flex is_between">
                  <label for="your-busyo">部署名
                    <p class="mand"><span>*</span></p>
                  </label>
                  <div class="input_list">
                    <div class="flex is_between">
                      <input type="text" id="your-busyo" name="your-busyo" placeholder="人事部　部長課長" class="form_input_yourbusyo input-your_busyo required" value="<?php echo $busyo; ?>">
                    </div>
                ...
                <div id="privacy_check_box"  class="privacy_check_box">
                  <p class="privacy_check_in">
                    <input type="checkbox" id="agree1" name="agree1" class="privacy_checkbox" <?php if($agree1){echo "checked";} ?>>
                ...
                <div id="privacy_check_box"  class="privacy_check_box">
                  <p class="privacy_check_in">
                    <input type="checkbox" id="agree2" name="agree2" class="privacy_checkbox" <?php if($agree2){echo "checked";} ?>>
