...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/estimate-confirm.css" />
        ...
        <header id="header">
            <div class="header__items flex is-between">
                ...
                <div class="header__right flex sp-only">
                    <a href="../shiryou/index.php" target="_top" class="download__document">
                    </a>
                        ...
                        <div class="common_contact contact_confirm">
                            <div class="inner_min">
                                <div class="contact_box">
                                    ...
                                    <div class="list flex is_between">
                                        <label for="your-staffNumber">従業員数</label>
                                        <div class="input_list">
                                            <div class="flex is_between">
